...
| 文件 | 状态 | 完成日期 | 备注 |
|------|:----:|:--------:|------|
| `pass_rate.py` | ✅ | 05-21 | 通过率计算：整体/分省/逐日/标准对比/去重口径 |
| `overdue.py` | ⏳ | - | 逾期率计算 |
...
| 05-21 | connectors 连接器模块实现→重构 | Phase 1.1 | 单类 get_data + 配置分离 + 恢复全部13个data_type |
| 05-21 | pass_rate 通过率指标模块 | Phase 1.2 | 整体/分省/逐日/标准对比/去重口径 |
