...
| 文件 | 状态 | 完成日期 | 备注 |
|------|:----:|:--------:|------|
| `factory.py` | ✅ | 05-21 | 连接器工厂，支持 starrocks/mysql/local |
| `starrocks.py` | ✅ | 05-21 | StarRocks 连接器 (pymysql)，含 query/query_one/execute |
| `mysql.py` | ✅ | 05-21 | MySQL 连接器，与 StarRocks 同接口，可互换 |
| `kafka.py` | ⏳ | - | Kafka 生产者（Phase 2） |
...
| 05-21 | connectors 连接器模块实现 | Phase 1.1 | factory/starrocks/mysql 三个文件 |
