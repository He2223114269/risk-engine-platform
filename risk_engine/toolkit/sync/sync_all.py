...
TABLES = [
    ("ods_ods_ts_v3_order_store", "SELECT * FROM ods.ods_ts_v3_order_store", 15843, False),
    (
...
def sync():
    ...
    local_conn = __import__("pymysql").connect(
        host=LOCAL_HOST, port=LOCAL_PORT, user=LOCAL_USER, password=LOCAL_PASS, database=LOCAL_DB
    )
